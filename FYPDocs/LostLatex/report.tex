...
The application has only one activity, dedicated to it's one function.
take a scan of local wireless points, create a Node for the main application based on that location ( and with a name given by the user )
